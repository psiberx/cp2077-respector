return {
	Inventory = {
		...
		-- Deals electrical damage and splits bullets into two.
		-- Increasing the chance to hit the target.
		{ id = "Preset_Nue_Maiko" }, 
		...
		{ id = "Preset_Liberty_Rogue" }, 

		-- PROBLEM SOLVER / Weapon / Power / SMG / Rare
		-- Don't bother aiming.
		-- Something's guaranteed to hit.
		{ id = "Preset_Saratoga_Raffen" }, 
