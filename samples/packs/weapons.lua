return {
	Inventory = {
		...
		-- HJSH-18 MASAMUNE [WITH FLASHLIGHT] / Weapon / Power / Assault Riffle
		...
		--  / Weapon / Melee / Blunt
		{ id = "Preset_Knuckles_Golden" }, 

		--  / Weapon / Melee / Blunt
		{ id = "Preset_Knuckles_Military" }, 

		--  / Weapon / Melee / Blunt
		{ id = "Preset_Knuckles_Pimp" }, 
