return {
	Inventory = {
		...
		{ id = "Preset_Butchers_Knife_Default" }, 
		...
		{ id = "Preset_Liberty_Military" }, 

		-- LIBERTY (NEON) / Weapon / Power / Pistol
		-- Smells like gunpowder. And freedom.
		{ id = "Preset_Liberty_Neon" }, 

		-- LIBERTY (PIMP) / Weapon / Power / Pistol
		-- Smells like gunpowder. And freedom.
		{ id = "Preset_Liberty_Pimp" }, 
		...
		-- Exercise your Second Amendment rights.
		{ id = "Preset_Defender_Pimp" }, 

		-- M2067 DEFENDER / Weapon / Power / LMG
		-- Exercise your Second Amendment rights.
		{ id = "Preset_Defender_Default" }, 
